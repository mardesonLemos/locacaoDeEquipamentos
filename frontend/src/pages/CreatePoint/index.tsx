...
const CreatePoint: React.FC = () => {
  ...
  return (
    <div id="page-create-point">
      <header>
        <img src={logo} alt="locacao pp" width={100} />
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          <legend>
            <h2>equipamentos</h2>
            <span>Selecione um ou mais equipamentos abaixo</span>
          </legend>
          ...
          <ul className="items-grid">
            {items.map(item => (
              ...
              >
                <img className="imagens" src={item.image_url} alt={item.title} />
        ...
        <button type="submit">Cadastrar uma loja</button>
      </form>
    </div>
  );
};
